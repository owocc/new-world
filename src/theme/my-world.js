...
/**
 * my-world theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { myWorldTheme } from './my-world';
 *   import './my-world.css';
 */
export const myWorldTheme = {
  name: 'my-world',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "system-ui, -apple-system, 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', 'Noto Sans SC', sans-serif",
    "--font-family-heading": "system-ui, -apple-system, 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', 'Noto Sans SC', sans-serif",
    "--font-family-code": "ui-monospace, SFMono-Regular, Menlo, 'PingFang SC', monospace",
    ...
    "--color-background-surface": "light-dark(#FFFBF8, #1F1B18)",
    "--color-background-body": "light-dark(#F6EFEC, #15100C)",
    "--color-background-card": "light-dark(#FFFBF8, #1F1B18)",
    "--color-background-popover": "light-dark(#FFFBF8, #342F2D)",
    "--color-background-muted": "light-dark(#1F1B180D, #1F1B1880)",
    "--color-accent": "light-dark(#9F410C, #FFB685)",
    ...
    "--color-neutral": "light-dark(#1F1B181A, #E8E1DE33)",
    "--color-overlay": "light-dark(#1F1B1866, #1F1B1899)",
    "--color-overlay-hover": "light-dark(#1F1B180D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#1F1B181A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#1F1B18, #E8E1DE)",
    "--color-text-secondary": "light-dark(#4F443F, #B5A9A2)",
    "--color-text-disabled": "light-dark(#9B8E88, #675C56)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#FFFFFF, #5B1C00)",
    ...
    "--color-icon-primary": "light-dark(#1F1B18, #E8E1DE)",
    "--color-icon-secondary": "light-dark(#4F443F, #B5A9A2)",
    "--color-icon-disabled": "light-dark(#9B8E88, #675C56)",
    ...
    "--color-border": "light-dark(#1F1B181A, #F6EFEC1A)",
    "--color-border-emphasized": "light-dark(#9B8E88, #716660)",
    "--color-skeleton": "light-dark(#B6A9A3, #4F453F)",
    ...
    "--color-background-inverted": "light-dark(#1F1B18, #FFFBF8)",
    "--color-track": "light-dark(#B6A9A3, #4F453F)"
  },
  components: {
    "heading": {
      "level:1": {
